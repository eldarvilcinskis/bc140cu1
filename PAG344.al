page 344 Navigate
{
    ...
    var
        ...
        [SecurityFiltering(SecurityFilter::Filtered)]PstdPhysInvtOrderHdr: Record "Pstd. Phys. Invt. Order Hdr";
    ...
    local procedure FindReturnShipmentHeader()
    begin
        if ReturnRcptHeader.ReadPermission then begin
          ReturnRcptHeader.Reset;
