codeunit 6620 "Copy Document Mgt."
{
            ...
            case FromDocType of
              ...
              SalesDocType::"Posted Invoice":
                begin
                  ...
                  OnCopySalesDocOnAfterTransferPostedInvoiceFields(ToSalesHeader,FromSalesInvHeader);
                end;
        ...
        with FromPurchRcptLine do
          if FindSet then
            repeat
              ...
              OnCopyPurchRcptLinesToDocOnAfterTransferFields(FromPurchLine,FromPurchHeader,ToPurchHeader);
        ...
        with FromPurchCrMemoLine do
          if FindSet then
            repeat
              ...
              OnCopyPurchCrMemoLinesToDocOnAfterTransferFields(FromPurchLine,FromPurchHeader,ToPurchHeader);
        ...
        with FromReturnShptLine do
          if FindSet then
            repeat
              ...
              OnCopyPurchReturnShptLinesToDocOnAfterTransferFields(FromPurchLine,FromPurchHeader,ToPurchHeader);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopySalesLineFromReturnRcptLineBuffer(var ToSalesLine: Record "Sales Line";FromReturnReceiptLine: Record "Return Receipt Line";IncludeHeader: Boolean;RecalculateLines: Boolean;var TempDocSalesLine: Record "Sales Line" temporary;ToSalesHeader: Record "Sales Header";FromSalesLineBuf: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCopyPurchCrMemoLinesToDocOnAfterTransferFields(var FromPurchaseLine: Record "Purchase Line";var FromPurchaseHeader: Record "Purchase Header";var ToPurchaseHeader: Record "Purchase Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCopyPurchRcptLinesToDocOnAfterTransferFields(var FromPurchaseLine: Record "Purchase Line";var FromPurchaseHeader: Record "Purchase Header";var ToPurchaseHeader: Record "Purchase Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCopyPurchReturnShptLinesToDocOnAfterTransferFields(var FromPurchaseLine: Record "Purchase Line";var FromPurchaseHeader: Record "Purchase Header";var ToPurchaseHeader: Record "Purchase Header")
    begin
    end;
