codeunit 408 "DimensionManagement"
{
    ...
    begin
        ...
        OnAfterGetRecDefaultDimID(RecVariant, CurrFieldNo, TableID, No, SourceCode, InheritFromDimSetID, InheritFromTableNo);
        exit(DefaultDimID);
    end;
    ...
    local procedure LogError(SourceRecVariant: Variant; SourceFieldNo: Integer; Message: Text; SupportURL: Code[20]) IsLogged: Boolean
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterGetRecDefaultDimID(RecVariant: Variant; CurrFieldNo: Integer; var TableID: array[10] of Integer; var No: array[10] of Code[20]; var SourceCode: Code[20]; var InheritFromDimSetID: Integer; var InheritFromTableNo: Integer)
    begin
    end;
}
