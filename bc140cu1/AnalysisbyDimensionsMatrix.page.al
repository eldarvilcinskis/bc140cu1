page 9249 "Analysis by Dimensions Matrix"
{
    ...
    [Scope('Personalization')]
    procedure Load2(NewAmountType: Option;ViewCode: Code[50];ShowOp: Boolean;ShowColumnNameLocal: Boolean;NewShowActualBudg: Option;NewAmountField: Option;NewClosingEntryFilter: Option;NewRoundingFactor: Option;NewShowInAddCurr: Boolean;NewMATRIX_ColumnCaptions: array [32] of Text[250];NewPrimKeyFirstCol: Text[1024])
    begin
