table 37 "Sales Line"
{
    ...
    fields
    {
        ...
        field(18;"Qty. to Ship";Decimal)
        {
            ...
            begin
                ...
                OnValidateQtyToShipAfterInitQty(Rec,xRec,CurrFieldNo);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckAssocPurchOrder(SalesLine: Record "Sales Line";FieldCaption: Text[250];var IsHandled: Boolean;xSalesLine: Record "Sales Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckItemAvailable(SalesLine: Record "Sales Line";CalledByFieldNo: Integer;var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCopyFromItem(var SalesLine: Record "Sales Line";Item: Record Item)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeShowItemSub(SalesLine: Record "Sales Line";var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnValidateNoOnBeforeUpdateDates(var SalesLine: Record "Sales Line";xSalesLine: Record "Sales Line";SalesHeader: Record "Sales Header";CallingFieldNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnValidateQtyToShipAfterInitQty(var SalesLine: Record "Sales Line";var xSalesLine: Record "Sales Line";CallingFieldNo: Integer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCopyFromItemOnAfterCheck(SalesLine: Record "Sales Line";Item: Record Item)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCalcPlannedDeliveryDate(SalesLine: Record "Sales Line";var PlannedDeliveryDate: Date;CallingFieldNo: Integer;var IsHandled: Boolean)
    begin
    end;
