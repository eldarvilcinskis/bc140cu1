codeunit 9170 "Conf./Personalization Mgt."
{
    ...
    var
        ...
        SalesRelationManagerIDTxt: Label 'Sales and Relationship Manager';
    ...
    procedure GetSalesAndRelationshipMgrProfile(): Code[30]
    begin
        exit(SalesRelationManagerIDTxt);
    end;

    procedure GetBusinessManagerProfile(): Code[30]
    begin
        exit(BusinessManagerIDTxt);
    end;

    procedure GetAccountantProfile(): Code[30]
    begin
        exit(AccountantTxt);
    end;

    procedure GetProjectManagerProfile(): Code[30]
    begin
        exit(ProjectManagerProfileTxt);
    end;

    procedure GetOrderProcessorProfile(): Code[30]
    begin
        exit(OrderProcessorProfileTxt);
    end;

    procedure GetProductionPlannerProfile(): Code[30]
    begin
        exit(ProductionPlannerProfileTxt);
    end;

    [Scope('Internal')]
    procedure ChangeSystemProfileDefaultRoleCenter("Profile": Record "All Profile")
    var
        SystemProfile: Record "Profile";
    begin
        if Profile.Scope = Profile.Scope::System then begin
    ...
    [Scope('Personalization')]
    procedure ChangeTenantProfileDefaultRoleCenter("Profile": Record "All Profile")
    var
