    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the description of the job WIP method. If the WIP method is system-defined, you cannot edit the description. You can enter a maximum of 50 characters, including spaces.';
                }
