codeunit 1750 "Data Classification Mgt."
{
    ...
    local procedure OnGetPrivacyMasterTables(var DataPrivacyEntities: Record "Data Privacy Entities")
    begin
    end;

    [Scope('Personalization')]
    procedure GetPrivacyMasterTables(var DataPrivacyEntities: Record "Data Privacy Entities")
    begin
    ...
    [Scope('Personalization')]
    procedure EntitiesExist(): Boolean
    var
        TempDataPrivacyEntities: Record "Data Privacy Entities" temporary;
        RecordRef: RecordRef;
    begin
