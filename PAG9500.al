    ...
    actions
    {
        area(processing)
        {
            ...
            group("Breakpoints Group")
            {
                ...
                action(BreakOnErrorIsOn)
                {
                    ApplicationArea = All;
                    Caption = 'Break On Error is On';
                    Image = BreakRulesOn;
                    Promoted = true;
                    PromotedCategory = Category6;
                    PromotedIsBig = true;
                    ToolTip = 'The debugger breaks code execution on error.';
                ...
                action(BreakOnErrorIsOff)
                {
                    ApplicationArea = All;
                    Caption = 'Break On Error is Off';
                    Image = BreakRulesOff;
                    Promoted = true;
                    PromotedCategory = Category6;
                    PromotedIsBig = true;
                    ToolTip = 'The debugger does not break code execution on error.';
